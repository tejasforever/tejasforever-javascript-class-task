...
const products= [
  ...
  const d= products.map(function(value){
  ...
  { 
    const product = carts.find(function(value){
    ...
    {
        const item = products.find(function(v) {
    ...
    document.getElementById("cartcount").innerHTML = carts.length;
